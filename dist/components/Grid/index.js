...
const GridBase = /*#__PURE__*/(0, _react.memo)(_ref2 => {
  ...
  const url = (stateData === null || stateData === void 0 || (_stateData$gridSettin2 = stateData.gridSettings) === null || _stateData$gridSettin2 === void 0 || (_stateData$gridSettin2 = _stateData$gridSettin2.permissions) === null || _stateData$gridSettin2 === void 0 ? void 0 : _stateData$gridSettin2.Url) || frameworkUrl;
  ...
  const CustomToolbar = function CustomToolbar(props) {
    ...
    }, " Bode"), !forAssignment && effectivePermissions.add && !isReadOnly && !showAddIcon && /*#__PURE__*/_react.default.createElement(_Button.default, {
      startIcon: !showAddIcon ? null : /*#__PURE__*/_react.default.createElement(_Add.default, null),
      onClick: onAdd,
      size: "medium",
      variant: "contained",
      className: classes.buttons
    }, "Dangote"), available && /*#__PURE__*/_react.default.createElement(_Button.default, {
      startIcon: !showAddIcon ? null : /*#__PURE__*/_react.default.createElement(_Add.default, null),
      onClick: onAssign,
      size: "medium",
      variant: "contained",
