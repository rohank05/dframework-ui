...
| `addUrlParamKey`       | `string`           | Key for additional URL parameters when navigating to forms and add name to the page title. [View Example](#addurlparamkey-and-searchparamkey-example)                                                                                                                                                                                                      |-                   |      No                |
| `searchParamKey`       | `string`           | Key for fetching parameters from the URL and show name on the page title. [View Example](#addurlparamkey-and-searchparamkey-example)                                                                                                                                                                                                                        | -                  |            No          |
...
| `permissions`      | `object`  | Permissions for grid actions, including adding, editing, deleting, and exporting data all property is true by default. <br> Example: `permissions: { add: false, edit: false, delete: false }`. <br> See the [Actions Table](#actions-table) for more details. | `true`          |
