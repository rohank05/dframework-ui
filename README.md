...
| `addCreatedByColumn`    | `boolean`         | Specified explicitly as false to hide the createdBy columns.                                                                                                                                                                                                                      | false                                       | No           |
...
| `rowRedirectLink`       | `string`          | URL to redirect when a row is clicked.                                                                                                                                                                                                                                            | false                                       | No           |
| `showAddIcon`           | `boolean`         | Indicates if the Add, Assign and Remove button icon should be displayed.                                                                                                                                                                                                          | false                                       | No           |
| `pageTitle`             | `string`          | Sets the title for the page.                                                                                                                                                                                                                                                      | `title`                                     | No           |
| `addUrlParamKey`        | `string`          | Key for additional URL parameters when navigating to forms.                                                                                                                                                                                                                       | -                                           | No           |
| `searchParamKey`        | `string`          | The key used to retrieve a parameter from the URL and display it as a breadcrumb in the page title. <br> Example: `searchParamKey: 'LookupType'`                                                                                                                                  | -                                           | No           |
| `enableGoBack`          | `boolean`         | Property determines whether to show the back button on the Title.                                                                                                                                                                                                                 | false                                       | No           |
| `showOnlyExcelExport`   | `boolean`         | Limits export options to only Excel formats.                                                                                                                                                                                                                                      | true                                        | No           |
| `initialValues`         | `object`          | Sets the default values for form fields when the form loads. <br> Example: `initialValues: { Active: true }`                                                                                                                                                                      | -                                           | No           |
| `applyFieldConfig`      | `function`        | A function to apply custom field configurations. Takes an argument { data } (where data is an object containing field values) and returns an object with field-specific configurations, such as disabled states. Specify the expected argument structure and return type clearly. | -                                           | No           |
| `getValidationSchema`   | `function`        | Returns a Yup validation schema for the form. Accepts { id } as an argument and outputs a Yup schema object based on column configurations.                                                                                                                                       | -                                           | No           |
| `relations`             | `array`           | Defines the relationship configurations for related grids.                                                                                                                                                                                                                        | -                                           | No           |
